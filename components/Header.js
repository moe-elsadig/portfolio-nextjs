    ...
    let buttonsMarkup = (
        <>
            ...
            <button
                ...
                className="focus-visible:ring-2 focus-visible:ring-pink-300 rounded-lg"
                onClick={() => {
                    setTheme(!theme);
                    changeTheme();
                }}
    ...
    return (
        <Headroom className="z-50">
            <div className="sticky top-0 z-50 shadow-md flex flex-row justify-between justify-items-center h-[60px] items-center backdrop-blur-lg bg-white dark:bg-[#101010]">
                ...
                <button
                    aria-label="Toggle dark mode"
                    className="md:hidden focus-visible:ring-2 focus-visible:ring-pink-300 rounded-lg"
                    onClick={() => {
                        setTheme(!theme);
                        changeTheme();
                    }}
                ...
                <div className="pr-5">
                    ...
                    >
                        <button
                            ...
                            className={`${buttonStyle} focus-visible:ring-2 focus-visible:ring-pink-300`}
                            onClick={() => setMenu()}
                        >
