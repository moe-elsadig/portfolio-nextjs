    ...
    let buttonsMarkup = (
        <>
            ...
            <button
                ...
                className="focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-300 rounded-lg p-1"
                onClick={() => {
                    setTheme(!theme);
                    changeTheme();
                }}
    ...
    return (
        <Headroom className="z-50">
            <div className="sticky top-0 z-50 shadow-md flex flex-row justify-between justify-items-center h-[60px] items-center backdrop-blur-lg bg-white dark:bg-[#101010]">
                ...
                <button
                    aria-label="Toggle Dark Mode"
                    className="md:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-300 rounded-lg p-1"
                    onClick={() => {
                        setTheme(!theme);
                        changeTheme();
                    }}
                ...
                <div className="pr-5">
                    ...
                    >
                        <button
                            ...
                            className={`${buttonStyle} focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-300`}
                            onClick={() => setMenu()}
                        >
